...
window.webcam = {
	...
	swf_url: 'http://srv-ad/condominio_collection2/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	...
	set_hook: function(name, callback) {
		...
		//console.log(this.hooks[name]+' hook name' + name);
	},
		...
		switch (type) {
			...
			case 'error':
				...
				if (!this.fire_hook('onError', msg)) {
					document.getElementsByClassName("webcam").innerHTML = "<img src='http://srv-ad/condominio_collection2/img/icone/dont_web.png' title='Câmera não identificada' alt='Câmera não identificada'>Câmera não identificada";
				}
				break;
